            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none w-full rounded-2xl border border-gray-300 px-5 py-4 pr-12 text-lg outline-none focus:ring-4 focus:ring-teal-100 focus:border-teal-500 transition bg-white"
                >
                ...
                <svg
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 w-5 h-5 pointer-events-none"
