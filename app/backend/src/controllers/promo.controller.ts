...
export class PromoController {
  async listPromos(request: NextRequest) {
    await connectDB();
  ...
  async validatePromo(request: NextRequest) {
    await connectDB();
  ...
  async adminListPromos(request: NextRequest) {
    await connectDB();
  ...
  async adminCreatePromo(request: NextRequest) {
    await connectDB();
  ...
  async adminUpdatePromo(request: NextRequest, id: string) {
    await connectDB();
  ...
  async adminDeletePromo(request: NextRequest, id: string) {
    await connectDB();
  ...
  async adminGeneratePromos(request: NextRequest) {
    await connectDB();
