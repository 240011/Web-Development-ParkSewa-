...
export class NotificationController {
  ...
  async markNotificationRead(request: NextRequest) {
    await connectDB();
  ...
  async deleteNotification(request: NextRequest, id: string) {
    await connectDB();
  ...
  async adminListNotifications(request: NextRequest) {
    await connectDB();
  ...
  async adminSendNotification(request: NextRequest) {
    await connectDB();
  ...
  async adminDeleteNotification(request: NextRequest, id: string) {
    await connectDB();
